...
public class VeloxDFS {
  ...
  //public native boolean write(long fid, byte[] buf);
  //public native boolean write(long fid, byte[] buf, long blockSize);
  public native boolean write(String file, byte[] buf, boolean commit);
  public native boolean write(String file, byte[] buf, long blockSize, boolean commit);
  public native boolean write_commit(String file);
