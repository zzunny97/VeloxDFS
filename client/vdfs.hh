...
class vdfs {
  ...
  public:
    ...
    bool write(std::string, std::string&, bool commit = false);
    bool write(std::string, std::string&, uint64_t, bool);
    //bool write(long, std::string&);
    //bool write(long, std::string&, uint64_t);
	bool write_commit(std::string);
